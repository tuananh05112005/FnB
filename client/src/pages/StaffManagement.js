...
import { listStaff, createStaff, updateStaff, deleteStaff, changeUserRole, toggleUserStatus as toggleUserStatusService } from "../services/staffService";
import {
  Table,
  Button,
  Container,
...
const UserManagement = () => {
  ...
  const toggleUserStatus = async (id, newStatus) => {
    ...
    try {
      await toggleUserStatusService(id, newStatus);
      fetchUsers();
    } catch (err) {
